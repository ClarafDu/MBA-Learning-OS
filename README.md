...
Map 支持搜索、缩放、平移、课程切换和跨课程知识关联。课程与知识点继续保留中英双语，自由文本翻译降级为 Google 翻译辅助入口。
账号跨设备同步与班级课件存储尚未开通；当前私人笔记保存在本机，课件区会明确显示访问状态。详见 [版本验收与缺口](docs/V1.3.0-RELEASE.md)。
