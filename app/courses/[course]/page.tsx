...
export default async function CoursePage({params}:{params:Promise<{course:string}>}){
 ...
 <div className="button-row course-workspace-links"><Link className="button" href={'/map?course='+slug}><T>知识地图</T> ↗</Link><Link className="button secondary" href="/calendar"><T>课程日历</T></Link><Link className="button secondary" href="/capture">补充要求 / 随手记</Link><Link href="/bilingual"><T>中英表达</T> →</Link></div>
