...
function Shell({children}: {children: React.ReactNode}) {
  ...
  return <div className="app-shell">
    ...
    <div className="workspace">
      ...
      <footer className="page-footer"><span><T>MBA Learning OS · V1.6.2</T></span><Link href="/calendar">Schedule</Link><Link href="/map">Map</Link><Link href="/my-os#backup"><T>数据备份</T></Link></footer>
    </div>
