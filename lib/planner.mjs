...
export function validateEvent(value) {
 ...
 if(value.visibility==='public' && (value.link || value.materialLink || value.description || !['class','midterm','final'].includes(value.kind))) throw Error('公开日历仅含课程或考试的时间、标题和地点 / Public calendar must exclude restricted details');
